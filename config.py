...
CONFIG = {
    ...
    'decay_depth': 0.25, # by the end of training the code will aim to exponentially decay lr to this amount of its original value
    ...
    'initial_and_final_ent_coef': (0.05, 0.01), # the initial and final coefficient of the entropy (decays from first to second)
